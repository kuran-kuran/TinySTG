...
#include <string.h>
#if defined(_WIN64)
#pragma comment(lib, "../../lib/sdl/sdl/lib/x64/SDL.lib")
#pragma comment(lib, "../../lib/sdl/sdl/lib/x64/SDLmain.lib")
#else
#pragma comment(lib, "../../lib/sdl/sdl/lib/x86/SDL.lib")
#pragma comment(lib, "../../lib/sdl/sdl/lib/x86/SDLmain.lib")
#endif
